...
use crate::{indexing::BindingOptions, IndexingScheme, ManyMatcher};
...
/// just the integer index given by the position in the string.
...
impl IndexingScheme<String, StringPosition> for StringIndexingScheme {
    ...
    where
        S: crate::IndexMap<Self::Key, StringPosition>,
    {
